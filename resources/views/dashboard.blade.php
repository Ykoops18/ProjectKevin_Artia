...
<div class="card border border-dark mt-2 mb-3" >
    <div class="card-header">
        <div class="container">
            <div class="row ">
                <div class="col-2 ">
                    <img class="card-img-left w-50 p-3" src="{{ asset('asset/img/user.png') }}">
                </div>
                <div class="col-5 ">
                    <h2 class="p-3 ">Hola {{ auth()->user()->username }}, crea tu post!</h2>
                </div>
            </div>
        </div>
    </div>
...
<!-- post uploaded -->
<div class="card-body text-dark p-5" style="background-color: rgba(128, 128, 128, 0.10)">
