...
<div class="row">
    <div class="col-4 p-5 text-center m-2 rounded-2">
        <form action="{{ route('imagenes.store') }}" method="POST" enctype="multipart/form-data" id="dropzone" class="dropzone rounded border border-1 w-100 h-100 items-center d-flex align-items-center justify-content-center">
            @csrf
        </form>
    </div>
